		...
		<script type="text/javascript">
			...
			function onload(){
									...
									if(imageURL){
										...
										btnHide.onclick = () => {
											...
											if(inputPromptPopup.__promptWindow){
												inputPromptPopup.__promptWindow.postMessage({type: 'Hide', id: promptContainer.parentElement.id}, location.origin);
											}
											resizeAll();
										};
				...
				function post(promptContainer){
					if(inputPromptPopup.__promptWindow){
						inputPromptPopup.__promptWindow.postMessage({type: 'Add', id: promptContainer.parentElement.id, data: promptContainer.innerHTML}, location.origin);
					}
				}
